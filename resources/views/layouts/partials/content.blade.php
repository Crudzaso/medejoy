    ...
    <div class="d-flex flex-column flex-column-fluid">
        <div class="card">
            <div class="card-body" style="width: 100%">
                <img src="{{asset('assets/logo/DALL·E 2024-11-14 15.09.10 - A lively raffle party scene indoors with colorful decorations like balloons, streamers, and banners. People are gathered around tables, some holding r.webp')}}" style="width: 100%; z-index: -1" id="raffle_img" alt="Bienvenidos">
                <div style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; background-color: black; animation: darken 2s forwards;"></div>
                <img src="{{asset('assets/logo/Dream_it_Raffle_it_Win_it-Photoroom.png')}}" style="position: absolute; top: 50%; left: 50%;bottom: 25%; transform: translate(-50%, -50%); width: 300px; height: auto; z-index: 1;">
